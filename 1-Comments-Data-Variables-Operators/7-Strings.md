...
1. [`Converting Between Character Encodings`](#converting-between-character-encodings)
    ...
    1. [`Convert from a Integer to a Character chr()`](#convert-from-an-integer-to-a-character-chr)
    1. [`Convert from a Character to an Integer ord()`](#convert-from-a-character-to-an-integer-ord)
